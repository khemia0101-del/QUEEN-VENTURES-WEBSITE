import { GrantflowWaitlistForm } from "@/components/GrantflowWaitlistForm";
import { APP_LOGO } from "@/const";
import { ArrowLeft } from "lucide-react";
import { Link } from "wouter";

export default function GrantflowWaitlistPage() {
  return (
      ...
      <div className="container py-12 md:py-20">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
            Grantflow Early Access
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join the waitlist for the future of automated grant management and be among the first to experience Grantflow.
          </p>
        </div>

        <GrantflowWaitlistForm />

        <div className="mt-12 text-center text-sm text-muted-foreground max-w-2xl mx-auto">
          <p>
            Grantflow is currently in development. By joining our waitlist, you'll receive exclusive updates, 
            early access opportunities, and special pricing when we launch.
          </p>
        </div>
      </div>
    </div>
